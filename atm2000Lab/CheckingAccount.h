...
public:
	...
	// To Do: declare a constructor that takes dollar, cents and fee initializes
	// the account balance to $dollars.cents and the check fee to fee
	CheckingAccount(int dollars, int cents, double fee);

	// To Do: declare a constructor that takes dollar, cents and fee intializes
	// the account balance to $dollars.00 and check fee to the fee
    	CheckingAccount(int dollars, double fee);

	// To Do: declare a default constructor initializes the account balance to
	// $0.00 and the check fee to $0.00%
    	CheckingAccount( );
...
private:
	...
	double check_fee; // expressed as a percent
